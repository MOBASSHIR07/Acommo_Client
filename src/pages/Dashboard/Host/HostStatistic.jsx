...
import { FaCalendarAlt, FaDollarSign, FaHome, FaChartLine, FaClock, FaUserTie } from "react-icons/fa";
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 bg-red-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <FaUserTie className="w-8 h-8 text-red-500" />
          </div>
    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-6 lg:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        <div className="flex items-center gap-3 mb-6 sm:mb-8">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Host Statistics</h1>
            <p className="text-gray-600 text-sm sm:text-base mt-1">
              Your hosting performance and earnings overview
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-10">
          <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">
                ${(statistics?.totalSales || 0).toLocaleString()}
              </p>
            </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm text-gray-500">Host Since</p>
              <p className="text-lg font-bold text-gray-900 mt-1">
                {formatTimestamp(statistics?.hostSince)}
              </p>
            </div>
            <div className="p-2 sm:p-3 bg-purple-50 rounded-lg sm:rounded-xl">
              <FaUserTie className="w-5 h-5 sm:w-6 sm:h-6 text-purple-500" />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              ...
              <p className="text-lg font-bold text-amber-600">
                ${statistics?.totalBookings ? Math.round(statistics.totalSales / statistics.totalBookings) : 0}
              </p>
            </div>
            <div className="text-center p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
